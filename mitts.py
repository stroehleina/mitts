...
def set_parser():
    ...
    parser.add_argument('--species', '-s', help=f'Species that you want to investigate 23S mutations for, choose from {list(Species.available.keys())}')
    parser.add_argument('--fastq1', '-1', help=f'R1 reads in FASTQ format (can be gzipped)')
    parser.add_argument('--fastq2', '-2', help=f'R2 reads in FASTQ format (can be gzipped)')
